...
const COLORS = {
  ...
  SLOT_BG: THEME_COLORS.BUTTON_PRIMARY,
  SLOT_HOVER: THEME_COLORS.BUTTON_PRIMARY_HOVER,
  SLOT_SELECTED: THEME_COLORS.BUTTON_PRIMARY_HOVER,
  SLOT_EMPTY: THEME_COLORS.BUTTON_PRIMARY,
  TEXT: TEXT_COLORS.ACCENT,
  TEXT_SECONDARY: TEXT_COLORS.SECONDARY,
  TEXT_DIM: TEXT_COLORS.MUTED,
  INPUT_BG: `#${THEME_COLORS.BUTTON_PRIMARY.toString(16).padStart(6, '0')}`,
  INPUT_BORDER: `#${THEME_COLORS.BORDER_SUBTLE.toString(16).padStart(6, '0')}`,
  INPUT_BORDER_FOCUS: TEXT_COLORS.ACCENT,
  BUTTON_BG: BUTTON.PRIMARY.bg,
  BUTTON_HOVER: BUTTON.PRIMARY.bgHover,
  BUTTON_TEXT: TEXT_COLORS.ACCENT,
  ERROR: TEXT_COLORS.DANGER,
  SUCCESS: TEXT_COLORS.ACCENT,
  CLOUD_BADGE: THEME_COLORS.BUTTON_PRIMARY_HOVER,
